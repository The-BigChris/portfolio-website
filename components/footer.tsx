        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="text-black">
            ...
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
              ...
              <li className="text-black font-serif">Product Management & Strategy</li>
              <li className="text-black font-serif">Digital Project Consulting</li>
              <li className="text-black font-serif">Team Leadership & Coordination</li>
